...
float ballX             = 100 ,  ballY             = 100; //Værdierne er blevet ændret til floats for at være kompitable med ballwalk
float eyeLeftRelativeX  = 5   ,  eyeLeftRelativeY  = 5; //Disse to værdier er blevet rettet til floats, da de bliver ganget med zoomFactor, som er en float
...
void draw() {                         
  float ballwalk =  sin(ballX*0.5)*10;  //svingning på +10 til -10 pixels //ballwalk er en kommentar og ikke en værdi
  ballX         =  ballX  +  speedX;    //flytter min bold 
  ballY         =  ballY  +  speedY + ballwalk; //ballwalk flytter på bolden i y-aksen, således den hopper fremad
